...
Use ? then the function name.
```{r}
?filter
```
This brought up 2 options, one of which was what I was looking for in dplyr.
...
cut_number is part of package ggplot2.
parse_number is part of package readr.
row_number is part of dplyr.
