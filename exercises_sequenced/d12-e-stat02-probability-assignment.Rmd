...
- What value of `fr` did you predict? I guessed half, 0.5.
- Did your prediction match your calculation? Not quite. It's 0.57.
...
- What value does `fr` appear to be limiting towards? 0.96 would make sense
...
- What value is `fr` approaching? Zero.
...
P is a probability, not frequency.
