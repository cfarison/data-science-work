...
**Observations**:
- Does the "gam" trend look linear? Kind of linear for the first bit, then not.
...
**Observations**:
- Which tends to be larger? `cty` or `hwy` mileage? hwy mpg tends to be higher
- What is the trend of mileage with `displ`? For lower engine displacement, mpg tends to be higher, and the trend is somewhat linear until about 5 liters.
