...
- Which `class` has the most vehicles? Hard to tell, 2 classes share the same color...count graph would be the best though.
- Which `class` has the broadest distribution of `cty` values? subcompact? density graph makes this  easier.
...
**Observations**
- You really need a small binwidth like 0.01 to see the groupings at certain carat levels.
