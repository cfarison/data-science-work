...
```
The 2 versions produce the same output, but using the pipe operator makes it easier to do subsequent operations on the data.
...
```
Rather than computing a mean price for all diamonds, after we use group_by we compute a mean for each combination of color and clarity.
...
- Ideal diamonds seem to vary most widely in price.
