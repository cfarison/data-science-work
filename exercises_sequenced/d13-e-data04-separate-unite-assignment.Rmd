...
## TODO: pivot and unite here!
  ...
  mutate(parent1a = parent1, parent1A = parent1) %>%
  unite(col = "a", parent1a, a, sep = "") %>%
  unite(col = "A", parent1A, A, sep = "")
df_q1
```
...
## TODO: pivot and separate here!
  pivot_longer(cols = -c(thick, rep), names_to = "code", values_to = "value") %>%
  separate(code, c("variable", "angle"), sep = -2) %>%
