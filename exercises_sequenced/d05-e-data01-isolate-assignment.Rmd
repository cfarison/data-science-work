...
The code is trying to show data points where destination is Boston, but it tried to use = instead of ==.
...
It looks for when the destination is equal to that variable, not the string "BOS".
...
city? Origin is JFK, LGA, or EWR for all flights.
...
Longest flights have a destination of HNL, Honolulu. This suggests that the only flights logged here are domestic, with destinations within the US.
