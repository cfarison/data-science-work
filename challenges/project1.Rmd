...
age_summary %>%
  ggplot() +
  geom_col(mapping = aes(x = age_group, y = total, fill = injury_mechanism), position = "dodge")
```

**Observations**:

- Diving deeper into 2014 data, the age groups with the highest incidence of unintentional falls are 0-4 and 75+. So maybe the increase in unintentional falls is due to older people living longer and thus there being more older people who may have unintentional falls.
