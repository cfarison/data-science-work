...
Background from my resident Materials Science expert:
...
- I'm curious if the material properties vary with thickness, and if they vary with angle. Which has a greater impact on them? And are the two of them linked?
...
- This graph does not seem to provide conclusive evidence to support the claim that Young's Modulus (E) is an intensive property. The points with lower thickness seem to have lower Young's modulus (E), and also lower shear modulus (mu).
