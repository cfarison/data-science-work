...
### EDA
Questions:
- In a map of the United States, which states have the highest case count per capita and death count per capita? Has that changed substantially in the past month?
