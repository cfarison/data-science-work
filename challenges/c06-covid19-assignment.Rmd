...
- How do the means and standard deviations vary by state? Can I show state means on a map, by color? And show the map for a few different dates to show changes over time?
