...
Wikipedia estimates 2224 total passengers. This dataset has 2201. Perhaps not all un-ticketed crew members were documented well.
...
df_titanic %>%
  filter(Survived == "Yes") %>%
  ggplot() +
  geom_point(mapping = aes(x = Class, y = n))
```
